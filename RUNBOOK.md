...
- Los scripts en `bin/` (`brand-sync.php`, `brand-reset.php`, `scaffold-vars.php`, `brand.php`) son LEGACY. No se usan. El plugin registra el comando `wp brand` directamente.
