...
class VisualImpactEngine:
    ...
    def translate_brief(self, brief: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 0. Componer narrativa: expandir a 6-8 secciones con ritmo visual
        from vie.narrative_composer import NarrativeComposer
        composed_brief = NarrativeComposer.compose(brief)
        sections_list = composed_brief.get("sections", [])

        # Activar design_direction si está presente en el brief
        design_direction = composed_brief.get("design_direction")
        ...
        # Pasar page_type al SectionBuilder para que LayoutComposer varie layouts
        page_type = composed_brief.get("page_type", "home")
        self.section_builder._page_type = page_type
        ...
        return {
            "title": composed_brief.get("title", "Page"),
            "slug": composed_brief.get("slug", "page"),
            "description": composed_brief.get("description", ""),
            "sections": sections,
            "_meta": {
